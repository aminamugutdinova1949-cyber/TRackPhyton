...
speed_in_kb_in_sec = speed  # TODO перевести скорость скачивания из байт в килобайты, если 1 килобайт = 1024 байта
time_in_sec = time  # TODO перевести время в секунды

free_traffic = 500  # количество бесплатного трафика
file_size = speed_in_kb_in_sec * time_in_sec  # TODO размер файла
total_coast = file_size * cost # TODO стоимость файла
